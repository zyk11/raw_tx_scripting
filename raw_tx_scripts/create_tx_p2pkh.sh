...
create_raw_tx() {
	...
	'{"jsonrpc": "1.0", "id":"curltest", "method":"createrawtransaction", "params": [''[ { "txid": "'$UTXO_TXID'", "vout": '$UTXO_VOUT' } ]'',''{ "'$RECIPIENT_ADDRESS'": '$AMOUNT'}'']}' \
	-H 'content-type: text/plain;' http://localhost:16590  | jq -r '.result')
